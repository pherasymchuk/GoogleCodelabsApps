...
fun BusScheduleApp(
    ...
    val uiState: BusScheduleUiState by viewModel.schedulesUiState.collectAsState()
    val fullSchedule: List<Schedule> = uiState.schedules
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                val routeSchedule: List<Schedule> by viewModel.getScheduleFor(stopName)
