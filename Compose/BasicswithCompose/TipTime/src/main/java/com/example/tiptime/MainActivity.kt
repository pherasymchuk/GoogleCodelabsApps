...
fun TipTimeLayout() {
    ...
    val tip: Tip = if (roundUp) Tip.RoundUp(amount, tipPercent) else Tip.Base(amount, tipPercent)
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.tip_amount, tip.value()),
...
@Preview
@Composable
private fun RoundTheTipRowPreview() {
    RoundTheTipRow(true, {})
}
